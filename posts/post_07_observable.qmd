...
Voy a adpatar un ejemplo sacado de [aquí](https://neocarto.github.io/bertin/examples/quarto.html)
...
- [A beginner's guide to using Observable JavaScript, R, and Python with Quarto](https://www.infoworld.com/article/3674789/a-beginners-guide-to-using-observable-javascript-r-and-python-with-quarto.html): una serie de 3 artículos de Infoworl de Sharon Machlis.
