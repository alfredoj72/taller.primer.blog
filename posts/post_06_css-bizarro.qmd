...
image: thumbnails/thumbnail_06.png
description: |
  El contenido de este post es el mismo quer el del anterior, **PERO** , pero ahora haciendo cambios **bizarros!!** con CSS.
#css: ["assets/mis_estilos_01.css" , "assets/mis_estilos_02.css"]
css: "assets/styles_post_05.css"
---

La apariencia visual del blog puede cambiarse utilizando CSS. El objetivo no es dar una clase de CSS, de hecho yo sé muy poquito CSS, sino solo mostrar con un ejemplo como poder incorporar algunos cambios en nuestro blog y, sobre todo en los posts, mediante CSS.

Sólo voy a implementar los cambios en este post: voy a dejar como están al resto de post y páginas de la web
...
En clase para mostrar como podemos modificar algunos de los elementos de un documento hecho con Rmd (ahora con Quarto) usaba un archivo css concambios digamos un poco raros: a lo mejor ponía el titulo en pink, el autor en verde etc.. etc... solo era un ejemplo para mostrar algunas de las posibilidades de modificar la apariencia de un documento con CSS.


- Si quieres ver como quedaría este mismo post pero sin utilizar las reglas CSS que puedes ver abajo, puedes hacerlo [aquí](/posts/post_05_css.html)
