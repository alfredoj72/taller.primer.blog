...
# Bienvenidos al taller!! :vulcan_salute::rose:
...
6.  Tuneado: **mejorando la web** (15 min)

. . .

7.  Gestión y **publicación** de la web/blog (5 min)
...
-   Proyecto en [desarrollo activo](https://quarto.org/docs/download/) ... mientras que Rmarkdown [it's not going away](https://yihui.org/en/2022/04/quarto-r-markdown/) ...
