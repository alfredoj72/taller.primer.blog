...
- Como estamos en unas slides, para ver las distintas opciones de layout que tenemos, es **mejor  verlas en los tutoriales del taller**, concretamente [aquí](https://perezp44.github.io/taller.primer.blog/taller/05_taller_escribir-posts.html#layout){target="_blank"} 
<br>
...
- Una de las novedades de Quarto es la posibilidad de usar **extensiones**.  Las extensiones se escriben en el lenguaje `Lua`. 

- [Aquí](https://quarto.org/docs/extensions/starter-templates.html) la documentación oficial.
...
- Para ver como instalar y usar extensiones vamos a ir al **tutorial nº 5 del taller**, concretamente [aquí](https://perezp44.github.io/taller.primer.blog/taller/05_taller_escribir-posts.html#extensiones){target="_blank"}
