...
Los **archivos importantes** ahora son 3:
 ...
 - `index.qmd` : generará (y dará formato) la "landing page" o Home. Esta página será un listado de páginas (un blog)
...
2. Modificar la **apariencia del blog** jugando con las opciones que nos proporciona Quarto (`index.qmd`). Gracias YAML inteligence!!
