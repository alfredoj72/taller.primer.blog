...
- Como estamos en unas slides, para ver las distintas opciones de layout que tenemos, es **mejor verlas** en uno de los post del fake-blog del taller; concretamente [aquí](/posts/post_01_layout.html){target="_blank"} 
...
- Para ver como instalar y usar extensiones vamos a ir, otra vez, a otro de los post del fake-blog del taller; concretamente [aquí](/posts/post_02_extensiones.html) 
