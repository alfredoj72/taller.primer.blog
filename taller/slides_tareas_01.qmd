...
-   `lang: es`: <https://quarto.org/docs/authoring/language.html>
...
-   Tendrás que mirar otras referencias, por ejemplo: [Customizing Quarto Websites: Make your website stand out using SASS](https://ucsb-meds.github.io/customizing-quarto-websites/#/title-slide) o [este video](https://www.youtube.com/watch?v=ErRX8plZpQE)
...
# FÍN!!  {.unnumbered .centered background-color="#562457"}
  ...
  - Bye, nos vemos en las próximas Jornadas
