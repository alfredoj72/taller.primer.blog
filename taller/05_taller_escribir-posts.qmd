...
Además de los elementos de escritura que nos ofrece la sintaxis básica de `markdown`. Quarto nos ofrece más posibilidades. Por ejemplo:
...
Los veremos con [este post](/posts/post_01_layout.qmd) en el fake-blog del taller.

<br>

### Extensiones

Las veremos con [este post](/posts/post_02_extensiones.qmd) en el fake-blog del taller.
...
En esta sección dedicaremos un tiempo a la práctica libre para la **creación y escritura de un post**. Para ello te ofrezco más abajo una plantilla plantilla para elaborar un post con diferentes elementos.
