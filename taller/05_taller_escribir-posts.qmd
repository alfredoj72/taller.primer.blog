...
El [editor visual](https://www.rstudio.com/blog/exploring-rstudio-visual-markdown-editor/) facilita la introducción de estos elementos en tus documentos. En [esta charla](https://mine-cetinkaya-rundel.github.io/2022-repro-toronto/#/title-slide) de Mine Çetinkaya-Rundel se aprecia fácilmente la **utilidad del editor visual**.
...
Vamos a aprender a usar las extensiones con un ejemplo: vamos a instalar la extensión "quarto-youtube-embed".
Con Rmd ponía algún vídeo en mis slides o tutoriales usando un paquete de R (ahora mismo no recuerdo el nombre del pkg). Ahora, con Quarto, podemos hacerlo usando la extensión  "quarto-youtube-embed". [Aquí](https://github.com/sellorm/quarto-youtube-embed) está el repo de la extensión. Veamos cómo.



{{< include ./_includes/_tt_05_46_tarea-5-04-extensiones.qmd >}}

Aunque esta extensión se ha quedado obsoleta porque Quarto ya incorpora de serie una extensión para incrustar vídeos. solo hay que usar el siguiente shortcode:
...
[Aquí](https://quarto.org/docs/authoring/videos.html) la documentación oficial del shortcode `{{ < video   >}}`.
...
Vamos a **instalar y usar una nueva extensión**, concretamente la extensión "Lightbox". Lo que hace esta extensión es que podamos pinchar en una imagen y ampliarla. [aquí](https://quarto-ext.github.io/lightbox/) un ejemplo de lo que se puede hacer con "Lightbox". Su repo [aquí](https://github.com/quarto-ext/lightbox)
...
En esta sección dedicaremos un tiempo a la práctica libre para que practiques la creación y escritura de un post. Para ello te ofrezco la siguiente un ejemplo/plantilla para elaborar un post con diferentes elementos.
