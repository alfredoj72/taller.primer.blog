...
#### Extensiones: Pongamos una pestaña más a la web

Si copias adecuadamente el chunk de abjao en el archivo `_quarto.yml` se creará una pestaña más en la barra de navegación de nuestra web. La pestaña se llamará "Más cosas" y tiene la particularidad de que se convertirá en un desplegable con acceso a varias páginas: "Docencia 2", "Docencia 3" y "Docencia 4".
