...
- Bueno, pues ya lo tenemos, ya tenemos un nuevo post. Lo que ocurre es que, como no hemos cambiado el contenido de `index.qmd` ni de `tumbnail.jpg`, resulta queel tercer post de nuestro blog será idéntico al primero, al post de bienvenida.
