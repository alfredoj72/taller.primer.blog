...
- Ahora este archivo no está referenciado en `_quarto.yml`, por lo que no se mostraríasi hacemos un rebuild^[Además, como nuestro Qproject ahora no tiene fichero `index.qmd` el rebuild no funcionaría].
...
- Simplemente, tendríamos que modificar las lineas 8 y 9 que ahora están refrenciando al fichero `about.qmd`. Por ejmeplo podríamos dejar las lineas 8 y 9 como se ve abajo:
